...
![主播放界面](file:///Users/weipt/WorkBuddy/20260414165951/app/docs/screenshots/main-player.png)

主界面包含旋转的黑胶唱片、歌曲信息、频谱可视化、进度条和播放控制。背景使用动态渐变色 + 漂浮粒子特效，颜色随当前歌曲主题自动切换。

### 📜 歌词面板

![歌词面板](file:///Users/weipt/WorkBuddy/20260414165951/app/docs/screenshots/lyrics-view.png)

默认展示歌词面板，当前播放行以渐变发光效果高亮，歌词自动滚动跟随播放进度。

### 📋 播放列表

![播放列表](file:///Users/weipt/WorkBuddy/20260414165951/app/docs/screenshots/playlist.png)

查看完整播放列表，支持收藏标记和一键切歌。当前播放曲目有迷你频谱指示器。

### 📁 本地音乐库

![本地音乐库](file:///Users/weipt/WorkBuddy/20260414165951/app/docs/screenshots/local-library.png)

点击顶部「本地」按钮打开本地音乐库面板。选择文件夹后，自动递归扫描所有支持的音频文件，按目录树结构展示。支持展开/折叠文件夹，点击任意歌曲即可播放。

### 🎬 哔哩哔哩面板

![哔哩哔哩面板](file:///Users/weipt/WorkBuddy/20260414165951/app/docs/screenshots/bilibili-panel.png)
