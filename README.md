...
| 🎨 主题系统 | 13 款精美主题（6 浅色 + 6 深色 + 自定义），全局颜色跟随变化 |
| 🔤 字体系统 | 6 种中文字体（苹方、思源黑体、站酷快乐体等），一键切换 |
| 📊 真实频谱 | Web Audio API 驱动，48 条柱状频谱随音乐节奏实时跳动 |
...
VibePlayer 内置 **13 款精心设计的主题**，分为**浅色系**和**深色系**两大类：

#### 🌞 浅色系（白色背景）

| 主题 | 主色调 | 风格特点 |
|------|--------|----------|
| **翡翠绿** 🌿 | `#10B981` | 清新自然，适合日间使用 |
| **天空蓝** 🔵 | `#3B82F6` | 清新宁静，轻松氛围 |
| **樱花粉** 🌸 | `#EC4899` | 温柔浪漫，唯美风格 |
| **薰衣草** 💜 | `#8B5CF6` | 优雅神秘，高级感 |
| **琥珀橙** 🟠 | `#F59E0B` | 温暖活力，秋日氛围 |
| **玫瑰红** ❤️ | `#EF4444` | 热情奔放，活力四射 |

#### 🌙 深色系（深色背景）

| 主题 | 主色调 | 风格特点 |
|------|--------|----------|
| **午夜蓝** 🌌 | `#3B82F6` | 深邃宁静，夜间沉浸 |
| **酒红夜** 🍷 | `#EF4444` | 热情浪漫，氛围感强 |
| **琥珀金** 👑 | `#F59E0B` | 温暖复古，怀旧情怀 |
| **极夜黑** ⚫ | `#E5E5E5` | 简约高级，专业感 |
| **赛博紫** 🚀 | `#8B5CF6` | 科技未来，未来感 |
| **翡翠暗** 🌿 | `#10B981` | 自然深沉，自然风 |
...
1. 点击顶部导航栏的 **⚙️ 设置按钮**
2. 在设置面板中选择 **🎨 主题风格** 或 **🔤 字体选择**
3. 点击喜欢的主题/字体即可**即时生效**

> 💡 **提示**：所有界面（音乐播放、视频、B站、WebDAV、AList 等）的颜色都会跟随主题自动变化！
